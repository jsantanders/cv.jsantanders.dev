      ...
      <div className="mx-auto w-full max-w-2xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1 space-y-2">
            ...
            <p className="max-w-md text-pretty font-space-mono text-base text-muted-foreground">
              {t("about")}
            </p>
            <p className="max-w-md items-baseline text-pretty font-space-mono text-base text-muted-foreground hover:[&_a]:underline hover:[&_a]:underline-offset-4">
              <a
            ...
            <div className="flex gap-x-1 font-space-mono text-base text-muted-foreground print:hidden">
